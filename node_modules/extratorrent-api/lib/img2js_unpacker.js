module.exports = {
    ...
    unpack: function(str) {
        ...
        if(typeof(window) === 'undefined') {
          ...
          var rdy = false;
          imgObj.onload = function () { rdy = true; };
          imgObj.onerror = function (e) { rdy = true; };
          imgObj.src = new Buffer(p[0], 'base64');

          require('deasync').loopWhile(function(){return !rdy;});
        ...
        if(typeof(window) === 'undefined') {
            return require('querystring').unescape(decodeURIComponent(require('atob')(resultStr)));
        }
        else {
