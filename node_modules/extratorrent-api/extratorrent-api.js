...
module.exports = class ExtraTorrentAPI {
  ...
  _advancedSearch(opts, date) {
    ...
    var _this = this;
    return this._get("/advanced_search/", { page:page, "with": with_words, extact:extact, without:without, category:category, added:added, seeds_from:seeds_from, seeds_to:seeds_to, leechers_from:leechers_from, leechers_to:leechers_to, size_from:size_from, size_to:size_to, size_type:size_type })
      .then(function(res) {
